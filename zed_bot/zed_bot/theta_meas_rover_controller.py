...
class ThetaMeasRoverController(Node):

    def __init__(self):
        super().__init__('theta_meas_rover_controller')
    ...
    def control_loop(self):
        ...
        if self.btn == 1 or (self.v_bwd_min < self.v_ref < self.v_min) or \
            ...
            self.steer_rad = self.steer_rad_lim
            ...
            self.pwm_data[0] = self.convert_ang_to_pwm(self.w_ref * self.steer_rad)
...
def main(args=None):
    ...
    arduino_serial_control = ThetaMeasRoverController()
